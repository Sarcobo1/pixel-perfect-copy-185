...
export const SceneSchema = z.object({
  ...
  // zoom_data fields
  zoomStat: z.coerce.string().optional(),      // e.g. "1.2M"
  ...
  // word_slide_mask / word_blur_focus fields
  mask_overflow: z.union([z.string(), z.boolean()]).optional(),
  enter_blur_px: z.number().optional(),
  cursor_glow: z.boolean().optional(),
  cameraMove: z.enum([
    "none",
    "zoom_in",
    "zoom_out",
